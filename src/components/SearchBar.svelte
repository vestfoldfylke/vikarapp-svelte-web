<script>
  import IconClose from "../components/IconClear.svelte";
  import IconSearch from "../components/IconSearch.svelte";
  ...
  export let clearSearchValue = null
  ...
  const clearSearch = () => {
    clear()
    searchValue = ''
    //  Causes a bug where if you select a new item after already selecting one the new item will not show as selected.
