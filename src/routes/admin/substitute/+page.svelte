<script>
    ...
    import { adminSubsTableData } from '$lib/helpers/stores.js'
    import { get } from 'svelte/store';
    import { convertDate } from '$lib/helpers/convert-date.js'
    import { extendSelectedSubstitutions, getVikarToken } from '$lib/useApi.js';
            ...
            for (const team of teachTeamsData) {
                ...
                for (const sub of substituteData) {
                    if (sub.teamId === teamId) {
                        ...
                        dbId = sub._id
                        teamExpiration = convertDate(sub.expirationTimestamp) // TODO: Noe muffens her med datoen
                    }
